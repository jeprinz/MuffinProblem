...
def findQ(m,s, spew=True):
	...
	V = Fraction(interval.findV(m,s))
	(sV, sVm1) = interval.getShares(m,s,V)
	dat = (m,s,V,Fraction(sV),Fraction(sVm1))
	...
	if spew:
		...
		print("C1: " + str(C1))
		print("D1: " + str(D1))
	MINONE = findMIN(A1,B1,C1,D1) #TODO: is MINEONE/MINTWO supposed to be able to not be defined?
